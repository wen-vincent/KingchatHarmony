...
void Conductor::OnAddTrack(
    ...
    const std::vector<rtc::scoped_refptr<webrtc::MediaStreamInterface>>&
        streams) {
OH_LOG_Print(LOG_APP, LOG_INFO, LOG_DOMAIN, "mytest", "OnAddTrack");
...
OH_LOG_Print(LOG_APP, LOG_INFO, LOG_DOMAIN, "mytest", "OnIceCandidate");
...
OH_LOG_Print(LOG_APP, LOG_INFO, LOG_DOMAIN, "mytest", "OnSignedIn");
...
void Conductor::OnPeerConnected(int id, const std::string& name) {
  RTC_LOG(LS_INFO) << __FUNCTION__;
OH_LOG_Print(LOG_APP, LOG_INFO, LOG_DOMAIN, "mytest", "OnPeerConnected");
...
void Conductor::StartLogin(const std::string& server, int port) {
  if (client_->is_connected())
    return;
OH_LOG_Print(LOG_APP, LOG_INFO, LOG_DOMAIN, "mytest", "StartLogin");
  server_ = server;
...
OH_LOG_Print(LOG_APP, LOG_INFO, LOG_DOMAIN, "mytest", "AddTracks");
  ...
  switch (msg_id) {
    case PEER_CONNECTION_CLOSED:
      RTC_LOG(LS_INFO) << "PEER_CONNECTION_CLOSED";
        OH_LOG_Print(LOG_APP, LOG_INFO, LOG_DOMAIN, "mytest", "PEER_CONNECTION_CLOSED");
      DeletePeerConnection();
    ...
    case SEND_MESSAGE_TO_PEER: {
      RTC_LOG(LS_INFO) << "SEND_MESSAGE_TO_PEER";
            OH_LOG_Print(LOG_APP, LOG_INFO, LOG_DOMAIN, "mytest", "SEND_MESSAGE_TO_PEER");
...
OH_LOG_Print(LOG_APP, LOG_INFO, LOG_DOMAIN, "mytest", "SendToPeer failed");
          DisconnectFromServer();
        }
        delete msg;
      }
